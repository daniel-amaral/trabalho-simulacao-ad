...
class TrataEvento:
    ...
    def __init__(self):
        self.__primeiro_fregues_a_avaliar = None

    def set_primeiro_fregues_a_avaliar(self, id_fregues):
        self.__primeiro_fregues_a_avaliar = id_fregues

    @property
    def primeiro_fregues_a_avaliar(self):
        return self.__primeiro_fregues_a_avaliar
    ...
    def __trata_evento_de_atendimento(self, evento, lista_de_eventos, gerador_exponencial, metricas):
        ...
        if (fregues.id >= self.primeiro_fregues_a_avaliar):
